...
//  ChatApp
//
//  Created by Selman Kaya on 1.02.2025.
//
...
class ConversationsTableViewCell: UITableViewCell {
    ...
    public func configure(with model: Conversation){
        ...
        let safeOtherUsermail = DatabaseManager.safeEmail(emailAddress: model.otherUserEmail)
        
        let path = "images/ \(safeOtherUsermail)_profile_picture.png"
